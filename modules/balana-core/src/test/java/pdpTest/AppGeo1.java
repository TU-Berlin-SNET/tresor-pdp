...
public class AppGeo1 
{
    ...
    public static void main( String[] args ) throws FileNotFoundException
    {
        ...
        //<string>/opt/NetBeans/TRESOR/WSO2-Balana-Basic_OK/policies-request/org.wso2.balana/geoxacml_testRequests/TestPolicy_0017.xml</string>
        
        String request = new Scanner(new File("/opt/NetBeans/TRESOR/WSO2-Balana-Basic_OK/policies-request/org.wso2.balana/geoxacmlRequest_XACML3_2")).useDelimiter("\\A").next();
