...
public class AppGeo1 
{
    ...
    public static void main( String[] args ) throws FileNotFoundException
    {
        ...
        String request = new Scanner(new File("/opt/NetBeans/TRESOR/WSO2-Balana/policies-request/geoxacml-policies/geoxacml-2-request-coordinates-permit.xml")).useDelimiter("\\A").next();
