...
public class AppGeo3 
{
    ...
    public static void main( String[] args ) throws FileNotFoundException
    {
        ...
        String request = new Scanner(new File("/opt/NetBeans/TRESOR/WSO2-Balana-Basic_OK/policies-request/geoxacml-policies/geoxacml-3-request-actions-within-campus-permit.xml")).useDelimiter("\\A").next();
