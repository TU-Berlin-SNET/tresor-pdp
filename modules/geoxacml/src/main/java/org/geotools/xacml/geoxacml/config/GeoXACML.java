...
public class GeoXACML {
    ...
    private static void registerGeoXACMLBaseFunctions() {
        ...
        factory.addFunction(SetFunction.getAtLeastOneInstance(functionName, GeometryAttribute.identifier));
        
        functionName = setPrefix + SetFunction.NAME_BASE_SET_EQUALS;
        factory.addFunction(SetFunction.getSetEqualsInstance(functionName, GeometryAttribute.identifier));
